...
<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/1.png" width="30%" alt="My favorite girl">
...
<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/6.jpg" width="70%" alt="new node">

如果报错了，请查看上面的代码，不一定都是你的问题，或者服务器问题，尤其SORA2，大部分情况是OPENAI的问题，当你发生500报错了，请在跑一次就可以了！

<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/oss.png" width="70%" alt="new node">
...
新增工作流RunNode-Nano-Banana-2-Edit-S2A.json，同步转异步，支持异步任务，可在网站后台异步任务查询(nano banana pro)

<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/s2a.png" width="100%" alt="new node">
...
新增节点：RunNode_Z_Image_Turbo
工作流晚上回去发

### 20251205

新增RunNode Doubao Seedream4.5节点，可使用豆包4.5，出图速度比大香蕉2快多了，人物一致性好过大香蕉，基准0.15，支持2K和4K
新增RunNode-doubao-seedream4_5_image_edit.json工作流
...
增加工作流：RunNode-nano-banana-V2(Gemini-3-pro-image-preview).json
目前是0.2积分/图

<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/6.png" width="100%" alt="new node">

### 20251117

增加2个新工作流，分别是Sora2角色创建节点，以及多角色@调用加图片参考混合工作流

RunNode-sora2-character-create.json --角色创建，创建将花费0.01积分，只需创建一次，可以无线调用

RunNode-sora2-multi-character.json --多角色@调用加图片参考混合
...
<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/4.png" width="100%" alt="new node">

然后链接复制到浏览器打开，如下也可以下载和分享

<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/5.png" width="60%" alt="new node">

### 20251023:

<img src="https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/3.png" width="100%" alt="new node">
...
[观看项目演示视频](https://github.com/T8mars/Comfyui-RunNode/blob/main/pic/ma.mp4)
